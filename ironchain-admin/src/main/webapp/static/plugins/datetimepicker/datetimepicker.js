...
! function($) {
    ...
    var Datetimepicker = function(element, options) {
        ...
        this.clearBtn = (options.clearBtn || this.element.data('date-clear-btn') || true);// add by zhengxin
    ...
    Datetimepicker.prototype = {
        ...
        fill: function() {
            ...
            this.picker.find('tfoot th.clear').text(dates[this.language].clear).toggle(this.clearBtn!==false); // add by zhengxin
            this.updateNavArrows();
            this.fillMonths();
    ...
    var DPGlobal = {
        ...
        footTemplate: '<tfoot><tr><th colspan="7" class="today"></th></tr><tr><th colspan="7" class="clear"></th></tr></tfoot>' // modify by zhengxin
    };
