...
<body>
	<div>
		...
		<div class="page">
			<div class="panel">
				<form id="searchForm" action="${ctx}/demand/class/list" method="get" class="search-form form-inline">
				<div class="panel-body">
			 	...
			 	<sec:authorize url="/demand/class/add">
			 		<button class="btn btn-primary" type="button" onclick="javascript:location.href='${ctx}/demand/class/add';"><i class="icon icon-plus"></i>新增</button>
			 	</sec:authorize>
			 	<sec:authorize url="/demand/class/delete">
	                ...
	                <tbody>
						<c:forEach items="${page.content}" var="item">
							<tr>
								...
								<td>
								<sec:authorize url="/demand/class/edit">
									<a href="${ctx}/demand/class/edit?id=${item.id}">编辑</a> |
								</sec:authorize>
								<sec:authorize url="/demand/class/delete"> 
