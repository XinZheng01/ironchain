...
<body>
	<div>
		...
		<div class="page">
			<div class="panel">
				<form id="searchForm" action="${ctx}/equipment/class/list" method="get" class="search-form form-inline">
				<div class="panel-body">
			 	...
			 	<sec:authorize url="/equipment/class/add">
			 		<button class="btn btn-primary" type="button" onclick="javascript:location.href='${ctx}/equipment/class/add';"><i class="icon icon-plus"></i>新增</button>
			 	</sec:authorize>
			 	<sec:authorize url="/equipment/class/delete">
						...
						<c:forEach items="${page.content}" var="item">
							<tr>
								...
								<sec:authorize url="/equipment/class/edit">
									<a href="${ctx}/equipment/class/edit?id=${item.id}">编辑</a> |
								</sec:authorize>
								<sec:authorize url="/equipment/class/delete"> 
...
function del(id){
	$.site.confirm("确定要删除选中的记录？", function(){
		$.site.loading();
		$.ajax({
			url: "${ctx}/equipment/class/delete",
			data: {"ids": id},
			type: "POST",
