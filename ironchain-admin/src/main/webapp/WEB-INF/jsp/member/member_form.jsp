	...
	<div>
		...
		<div class="page">
			<ul class="nav nav-tabs">
			  ...
			  <li id="tabChildLi"><a data-tab href="#tabChild">子账号管理</a></li>
			</ul>
			<form:form id="saveForm" modelAttribute="member" action="save" cssClass="form-horizontal">
			  ...
			  <div class="tab-content">
			  	  <div class="tab-pane active" id="tabPerson">
					  ...
					  <div class="form-group">
					    <label for="headImg" class="col-sm-2">用户头像</label>
					    <div class="col-md-4 col-sm-6">
					  ...
					  <div class="form-group">
					    <label for="mobilephone" class="col-sm-2 required">手机号码</label>
					    <div class="col-md-4 col-sm-6">
					  ...
					  <div class="form-group">
					    <label for="newPassword" class="col-sm-2">密码</label>
					    <div class="col-md-4 col-sm-6">
					      <input type="password" name="newPassword" class="form-control" id="newPassword" placeholder="请输入密码">
				  ...
				  <div class="tab-pane" id="tabCompany">
					  ...
					  <div class="form-group">
					    <label for="companyAddress" class="col-sm-2">企业地址</label>
					    <div class="col-md-4 col-sm-6">
						  <form:input path="companyAddress" cssClass="form-control" id="companyAddress" placeholder="请输入企业地址"/>
					    </div>
					  </div>
					  <div class="form-group">
					  	<label class="col-sm-2">工厂位置</label>
					  	<div class="col-md-4 col-sm-6 location-content">
					  		<input type="text" class="form-control" placeholder="请设置工厂位置" data-gdarea readonly>
							<a class="btn btn-link new-param" ><i class="icon icon-plus"></i>新增位置</a>
					  	</div>
				  	</div>
				  </div>
			  </div>
