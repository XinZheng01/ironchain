...
public class JsonKit {
	...
	private static Logger logger = LoggerFactory.getLogger(JsonKit.class);
	 ...
	 * 默认.
	 */
	public static JsonKit normal() {
		if(normal == null){
			normal = new JsonKit(Include.ALWAYS);
		}
		return normal;
	}
	/**
	 ...
	 */
	public static JsonKit nonDefault() {
		if(nonDefault == null){
			nonDefault = new JsonKit(Include.NON_DEFAULT);
		}
		return nonDefault;
	}
